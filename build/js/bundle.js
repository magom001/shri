...
"use strict";
eval("\n\n__webpack_require__(/*! babel-polyfill */ \"./node_modules/babel-polyfill/lib/index.js\");\n\n__webpack_require__(/*! classlist-polyfill */ \"./node_modules/classlist-polyfill/src/index.js\");\n\nvar _isMobile = _interopRequireDefault(__webpack_require__(/*! is-mobile */ \"./node_modules/is-mobile/index.js\"));\n\nvar _Modal = __webpack_require__(/*! ./Modal */ \"./src/js/Modal.js\");\n\nvar _PageScroll = __webpack_require__(/*! ./PageScroll */ \"./src/js/PageScroll.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar App =\n/*#__PURE__*/\nfunction () {\n  function App() {\n    _classCallCheck(this, App);\n\n    this.cancelScroll = this.cancelScroll.bind(this);\n    this.scroll = this.scroll.bind(this);\n    this.IS_MOBILE = (0, _isMobile.default)();\n    this.init();\n  }\n\n  _createClass(App, [{\n    key: \"init\",\n    value: function init() {\n      this.setupModal();\n\n      if (!this.IS_MOBILE) {\n        this.setupSelectedScenariosScroll();\n        this.setupSelectedAppliancesScroll();\n        this.setupMainWidgetScroll();\n      }\n    }\n  }, {\n    key: \"cancelScroll\",\n    value: function cancelScroll() {\n      this.isScrolling = false;\n      cancelAnimationFrame(this.requestID);\n    }\n  }, {\n    key: \"scroll\",\n    value: function scroll(value) {\n      var _this = this;\n\n      this.isScrolling = true;\n      this.widgetAppliancesContent.scrollLeft += value;\n\n      if (this.widgetAppliancesContent.scrollLeft > 0) {\n        this.widgetAppliancesScrollLeftBtn.removeAttribute(\"disabled\");\n      } else {\n        this.widgetAppliancesScrollLeftBtn.setAttribute(\"disabled\", true);\n        this.cancelScroll();\n        return;\n      }\n\n      if (this.widgetAppliancesContent.scrollLeft < this.widgetAppliancesContentScrollWidth - this.widgetAppliancesContentWidth) {\n        this.widgetAppliancesScrollRightBtn.removeAttribute(\"disabled\");\n      } else {\n        this.widgetAppliancesScrollRightBtn.setAttribute(\"disabled\", true);\n        this.cancelScroll();\n        return;\n      }\n\n      this.requestID = requestAnimationFrame(function () {\n        return _this.scroll(value);\n      });\n    }\n  }, {\n    key: \"setupModal\",\n    value: function setupModal() {\n      var _this2 = this;\n\n      this.modal = new _Modal.Modal();\n      document.addEventListener(\"click\", function (e) {\n        if (e.target.classList.contains(\"action-box\")) {\n          _this2.modal.openModal(e.target);\n        }\n      }, true);\n    }\n    /**\r\n     *\r\n     * Setup selected appliances horizontal scroll\r\n     *\r\n     */\n\n  }, {\n    key: \"setupSelectedAppliancesScroll\",\n    value: function setupSelectedAppliancesScroll() {\n      var _this3 = this;\n\n      this.widgetAppliancesScrollRightBtn = document.querySelector(\".widget-appliances__scroll\").querySelector(\".widget__scroll_right\");\n      this.widgetAppliancesScrollLeftBtn = document.querySelector(\".widget-appliances__scroll\").querySelector(\".widget__scroll_left\");\n      this.widgetAppliancesContent = document.querySelector(\".widget-appliances__content\");\n      this.widgetAppliancesContentWidth = this.widgetAppliancesContent.getBoundingClientRect().width;\n      this.widgetAppliancesContentScrollWidth = this.widgetAppliancesContent.scrollWidth;\n      this.widgetAppliancesContent.addEventListener(\"wheel\", function (e) {\n        _this3.scroll(e.deltaY);\n\n        _this3.cancelScroll();\n      });\n      this.widgetAppliancesScrollLeftBtn.addEventListener(\"mousedown\", function () {\n        _this3.scroll(-10);\n      });\n      this.widgetAppliancesScrollLeftBtn.addEventListener(\"touchstart\", function () {\n        _this3.scroll(-10);\n      });\n      this.widgetAppliancesScrollRightBtn.addEventListener(\"mousedown\", function () {\n        _this3.scroll(10);\n      });\n      this.widgetAppliancesScrollRightBtn.addEventListener(\"touchstart\", function () {\n        _this3.scroll(10);\n      });\n      document.addEventListener(\"mouseup\", function () {\n        if (_this3.isScrolling) {\n          _this3.cancelScroll();\n        }\n      });\n      document.addEventListener(\"touchend\", function () {\n        if (_this3.isScrolling) {\n          _this3.cancelScroll();\n        }\n      });\n    }\n    /**\r\n     *\r\n     * Selected scenarios full page scroll\r\n     *\r\n     */\n\n  }, {\n    key: \"setupSelectedScenariosScroll\",\n    value: function setupSelectedScenariosScroll() {\n      this.leftBtn = document.getElementById(\"scenarios-scroll\").querySelector(\".widget__scroll_left\");\n      this.rightBtn = document.getElementById(\"scenarios-scroll\").querySelector(\".widget__scroll_right\");\n      this.target = document.getElementById(\"scenarios-pages\");\n      new _PageScroll.PageScroll(this.leftBtn, this.rightBtn, this.target);\n    }\n    /**\r\n     * Main widget right column scroll\r\n     */\n\n  }, {\n    key: \"setupMainWidgetScroll\",\n    value: function setupMainWidgetScroll() {\n      var _this4 = this;\n\n      this.rightColumn = document.querySelector(\".widget-main__column_right\");\n      this.rightColumnFirstChild = this.rightColumn.firstElementChild;\n      this.scrollIndicator = document.querySelector(\".widget-main__scroll-indicator\");\n      this.rightColumn.addEventListener(\"scroll\", function () {\n        var rcRect = _this4.rightColumn.getBoundingClientRect();\n\n        var rcFcRect = _this4.rightColumnFirstChild.getBoundingClientRect();\n\n        if (Math.floor(rcRect.top + 20) > Math.ceil(rcFcRect.top)) {\n          _this4.scrollIndicator.classList.add(\"widget-main__scroll-indicator--hidden\");\n        } else {\n          _this4.scrollIndicator.classList.remove(\"widget-main__scroll-indicator--hidden\");\n        }\n      });\n    }\n  }]);\n\n  return App;\n}();\n\nnew App();\n\n//# sourceURL=webpack:///./src/js/app.js?");
